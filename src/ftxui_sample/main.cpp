...
// configuration step. It creates a namespace called `SuperGuru`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", SuperGuru::cmake::project_name, SuperGuru::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", SuperGuru::cmake::project_version);
      return EXIT_SUCCESS;
    }
